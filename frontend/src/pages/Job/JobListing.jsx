  ...
  const topics = [
    {
      id: 1,
      title: 'Web Design',
      description: 'Topic Listing includes home, listing, detail and contact pages...',
              ...
              <div className="row mb-3">
                <div className="col-12">
                  <div
                    ...
                    />
                    <button className="btn text-white col-2" type="submit"
              ...
              <div className="row">
                <div className="col-md-3 col-sm-6 mb-2">
                  <div className="dropdown w-100">
                    <button className="btn btn-light dropdown-toggle w-100 text-start p-3" type="button" id="locationDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                      Tất cả địa điểm
                    </button>
                    <ul className="dropdown-menu w-100" aria-labelledby="locationDropdown">
                ...
                <div className="col-md-3 col-sm-6 mb-2">
                  <div className="dropdown w-100">
                    <button className="btn btn-light dropdown-toggle w-100 text-start p-3" type="button" id="levelDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                      Tất cả cấp bậc
                    </button>
                    <ul className="dropdown-menu w-100" aria-labelledby="levelDropdown">
                      <li><a className="dropdown-item" href="#">Nhân viên</a></li>
                      <li><a className="dropdown-item" href="#">Quản lý</a></li>
                      <li><a className="dropdown-item" href="#">Giám đốc</a></li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="col-md-3 col-sm-6 mb-2">
                  <div className="dropdown w-100">
                    <button className="btn btn-light dropdown-toggle w-100 text-start p-3" type="button" id="jobTypeDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                      Tất cả loại công việc
                    </button>
                    <ul className="dropdown-menu w-100" aria-labelledby="jobTypeDropdown">
                      <li><a className="dropdown-item" href="#">Toàn thời gian</a></li>
                      <li><a className="dropdown-item" href="#">Bán thời gian</a></li>
                ...
                <div className="col-md-3 col-sm-6 mb-2">
                  <div className="d-flex">
                    <div className="dropdown flex-grow-1 me-2">
                      <button className="btn btn-light dropdown-toggle w-100 text-start p-3" type="button" id="contractDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                        Tất cả loại hợp đồng
                      </button>
                      <ul className="dropdown-menu w-100" aria-labelledby="contractDropdown">
                        <li><a className="dropdown-item" href="#">Dài hạn</a></li>
                        <li><a className="dropdown-item" href="#">Ngắn hạn</a></li>
                        <li><a className="dropdown-item" href="#">Dự án</a></li>
                      </ul>
                    </div>
                          ...
                          <div key={topic.id} className="col-12 mb-4">
                            <div className="custom-block custom-block-topics-listing bg-white shadow-lg p-4 d-flex align-items-center">
                              ...
                              <div className="flex-grow-1">
                                <h5 className="mb-2">{topic.title} <span className="badge bg-danger">Hot Job</span></h5>
                                ...
                                <Link to="/topic-detail" className="btn custom-btn mt-2">Learn More</Link>
                              </div>
                              <span className="badge bg-design rounded-pill ms-auto">{topic.count}</span>
                            </div>
                          </div>
                      ))
                  ) : (
