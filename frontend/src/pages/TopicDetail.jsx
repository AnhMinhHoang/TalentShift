            ...
            <div className="row justify-content-center align-items-center">
              ...
              <div className="col-lg-5 col-12 mb-5">
                ...
                <div className="d-flex align-items-center mt-5">
                  <Link to="/" className="btn custom-btn custom-border-btn smoothscroll me-4">Read More</Link>
                ...
                <div className="row my-4">
                  <div className="col-lg-6 col-md-6 col-12">
                    <img src="/asset/images/businesswoman-using-tablet-analysis.jpg"
                         className="topics-detail-block-image img-fluid" alt=""/>
                  </div>

                  <div className="col-lg-6 col-md-6 col-12 mt-4 mt-lg-0 mt-md-0">
                    <img src="/asset/images/colleagues-working-cozy-office-medium-shot.jpg"
                         className="topics-detail-block-image img-fluid" alt=""/>
                  </div>
                </div>
        ...
        <section className="section-padding section-bg">
          <div className="container">
            <div className="row justify-content-center">
              ...
              <div className="col-lg-5 col-12">
                <img src="/asset/images/rear-view-young-college-student.jpg" className="newsletter-image img-fluid" alt=""/>
              </div>
