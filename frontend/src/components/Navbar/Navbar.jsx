              ...
              <div className={`nav-item dropdown ${styles.userDropdown}`}>
                ...
                >
                  <div className={styles.userInfo}>
                    ...
                    {hasCustomAvatar() ? (
                      <AvatarWithFallback
                        src={userData.role === "HIRER" ? getImageUrl(userData.logoPath) : getImageUrl(userData.avatar)}
                        alt={userData.role === "HIRER" ? userData.companyName : userData.fullName}
                        name={userData.role === "HIRER" ? userData.companyName : userData.fullName}
                        size={36}
                ...
                <ul className={`dropdown-menu dropdown-menu-end ${styles.dropdownMenu}`} aria-labelledby="userDropdown">
                  ...
                  <li>
                    <Link to="/transaction-history" className={`dropdown-item ${styles.dropdownItem}`}>
